...
var SolutionBuilderHost = (function (_super) {
...
var Compiler = (function () {
    function Compiler(options, host, pastProgram, transformers) {
    ...
    Compiler.prototype.fileEmit = function (fileName, sourceFile) {
        ...
        /*emitOnlyDtsFiles*/ false, this.transformers ? this.transformers(this.program) : undefined);
        return {
            fileName: fileName,
...
(function (TsCompiler) {
     ...
     */
    function compile(rootFileNames, compilerOptions, transformers) {
        var compiler = new Compiler(compilerOptions, /*host*/ undefined, /*program*/ undefined, transformers);
    ...
    function compileModule(input, moduleFileName, compilerOptions, transformers) {
        var compiler = new Compiler(compilerOptions, /*program*/ undefined, /*host*/ undefined, transformers);
     ...
     * @returns A {@link CompileResult}
     */
    function compileProject(configFilePath, transformers) {
        var config = TsCore.getProjectConfig(configFilePath);
        if (config.errors.length > 0) {
            return new CompileResult(CompileStatus.DiagnosticsPresent_OutputsSkipped, config.errors);
        }
