...
var Compiler = (function () {
    function Compiler(options, program, host, plugins) {
    ...
    Compiler.prototype.compileProgram = function (program) {
        this.program = ts.createProgram(program.getRootFileNames(), this.options, this.host, program);
        return this.emit();
    };
...
(function (TsCompiler) {
    ...
    function compile(fileNames, compilerOptions, transforms) {
    ...
    function compileProgram(program, transform) {
        var compiler = new Compiler(program.getCompilerOptions(), /*program*/ undefined, /*host*/ undefined, transform);
        return compiler.compileProgram(program);
    }
    TsCompiler.compileProgram = compileProgram;
